...
#ifndef LV_ATTRIBUTE_IMAGE_{var_name.upper()}
#define LV_ATTRIBUTE_IMAGE_{var_name.upper()}
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMAGE_{var_name.upper()} uint8_t {var_name}_map[] = {{
